 ...
 * @author user
 */
public class USSDService extends HttpServlet {
            ...
            switch (ussd.getRequestType()) {
                ...
                case CONTINUE:
                    ...
                    if(option.equals("#"))
                    {
                            ...
                            break; // break out, pull yourself up and dust yourself!
                    }
                    
                    
                    if(option.equals("0") || option.equalsIgnoreCase("o"))
                    {
                        
                        ussd.setUSSDString("Thanks for adding stuff");
                        s.setState(0);
                        s.setMenu(null);
                        s.setCurrentPage(0);
                    ...
                    if (m == null) {
                        throw new Exception("Invalid Menu Selection still on 8167");
                    }
                    ...
                    switch (m) {
                        ...
                        case Addition:
                            switch (s.getState()) {
                                ...
                                case 1:
                                    ...
                                    StringBuilder sb = new StringBuilder("Enter first number");
                                    ussd.setRequestType(RequestType.INITIATE);
                        ...
                        default:
                            ussd.setRequestType(TERMINATE);
                            ussd.setUSSDString("Invalid menu selection still on 236, re-route unsuccessful");
                            SessionDAO.deleteSession(MSISDN);
                            break;
                    }
            }
    ...
    public String getMenu() {
        ...
        sb.append("Welcome to Math Calculator\n");
        for (Menu m : Menu.values()) {

            sb.append(String.format("%d)%s%n", m.getID(), m.getDescription()));
        }
        return sb.toString();
    }
